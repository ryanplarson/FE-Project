...
#maybe center rolling windows plot around focal year
#reorder unemployment lags
#call ex-fel percentage to felony history pct.
...
ggplot(bt, aes(x=start.year, y=est)) +
  ...
  geom_hline(yintercept=0, linetype="dashed", 
                color = "red", size=.5)+
  scale_x_continuous(limits = c(1987, 2007), breaks = c(seq(1988,2006,2))) +
  theme_bw()+
...
stargazer(y1.fe.d, y2.fe.d, y3.fe.d,
          type="latex", style="aer", title="Alternative Specifications of Disability", covariate.labels= c(
                                                  ...
                                                  "Ovr. Unemp. Rate t-2","Ovr. Unemp. Rate t-3",
                                                  "Ovr. Unemp. Rate t"),
          dep.var.labels=c("with SSI","Miss","Miss without SSI"),
          header=F, p.auto=F,
          notes=c("Clustered Standard Errors by State and Year.", "Weighted by State-Year total pop."), 
