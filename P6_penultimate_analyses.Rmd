...
#rolling average effect, run model on each window, collect coefficients/ses and plot them 


#9/11

#run models with disability rates
  #SSDI and ASEC disab rate

#run models with missing series set to 0, also set to NA

#can predict state-year disability based off of regression

#change age grouping in penultimate to 18-54

#cleaner identification (raphael, sentencing reforms)
...
```{r, include=F}
fe.fd <- fe.ov %>% select(YEAR, STATENAME, p6.y1.notemployed.rate, p6.y3.idle.rate, 
...
y1.fe <- plm(p6.y1.notemployed.rate~pctexfel, data = fe.ov, weights = norm.weight, 
...
y1.fe.3 <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                 ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio, data = fe.ov, 
...
y1.fe.4 <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                  ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
...
y1.fe.5 <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
...
y2.fe <- plm(p6.y2.unemployed.rate~pctexfel, data = fe.ov, weights = norm.weight,
             index = c("STATENAME","YEAR"), effect="twoway", model="within")
...
y3.fe <- plm(p6.y3.idle.rate~pctexfel, data = fe.ov, weights = norm.weight,
             index = c("STATENAME","YEAR"), effect="twoway", model="within")
...
y3.fe.5 <- plm(p6.y3.idle.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+t.unemp.rate,
                  data = fe.ov, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
...
y4.fe <- plm(p6.y4.cfw.rate~1+pctexfel, data = fe.ov, weights = norm.weight,
             index = c("STATENAME","YEAR"), effect="twoway", model="within")
...
y4.fe.5 <- plm(p6.y4.cfw.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+t.unemp.rate,
                  data = fe.ov, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
...
fe.p6 <- fe %>% select(YEAR, STATENAME, STATEFIP, p6.pop,popshare.16.25, popshare.26.35, popshare.36.45,
                       popshare.46.55, popshare.56.65, popshare.66.plus, t.unemp.rate,
...
p6.y1.male <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                  ...
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+t.unemp.rate,
                  data = fe.p6, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
...
fe.p6.female <- fe %>% select(YEAR, STATENAME, STATEFIP, p6.pop.female, popshare.16.25, popshare.26.35, popshare.36.45,
                       ...
                       p6.marriage.rate.female, pctexfel, ssdi.rate, effective.wage, 
                       TANF.mu, z_labor_unemployment_compensatio,time.indicator) %>%
                      mutate(ssi.rate=ssi.rate, norm.weight = p6.pop.female*(1550/sum(p6.pop.female)))%>% rename(marriage.rate= p6.marriage.rate.female)

p6.y1.female <- plm(p6.y1.notemployed.rate.female~pctexfel+
...
fe.p6.black <- fe %>% select(YEAR, STATENAME, STATEFIP, p6.pop.b, popshare.16.25, popshare.26.35, popshare.36.45,
                       ...
                       p6.marriage.rate.b, pctexfel, ssdi.rate, effective.wage, 
                       TANF.mu, z_labor_unemployment_compensatio,time.indicator) %>%
                      mutate(ssi.rate=ssi.rate, norm.weight = p6.pop.b*(1550/sum(p6.pop.b, na.rm=T))) %>% rename(marriage.rate=p6.marriage.rate.b)
...
fe.p6.white <- fe %>% select(YEAR, STATENAME, STATEFIP, p6.pop.w,popshare.16.25, popshare.26.35, popshare.36.45,
                       ...
                       p6.marriage.rate.w, pctexfel, ssdi.rate, effective.wage, 
                       TANF.mu, z_labor_unemployment_compensatio,time.indicator) %>%
...
stargazer(p6.y1.male, p6.y1.female, p6.y1.black, p6.y1.white, p2.y1.work,
          type="latex", style="aer", title="Alternative Sample Models" , covariate.labels= c(
                                                  ...
                                                  "Ovr. Unemp. Rate t-2","Ovr. Unemp. Rate t-3",
                                                  "Ovr. Unemp. Rate t"),
          dep.var.labels=c("P6 Male","P6 Female","P6 Black","P6 White","WA All"), header=F, p.auto=F,
          notes=c("Clustered Standard Errors by State and Year.", "Weighted by State-Year total pop."),
...
y1.fe.int <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
...
y2.fe.int <- plm(p6.y2.unemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
...
y3.fe.int <- plm(p6.y3.idle.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+t.unemp.rate+year.lin+year.lin*pctexfel,
                  data = fe.ov, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
y3.fe.robust.int <- coeftest(y3.fe.int, vcov=vcovHC(y3.fe.int,type="HC0",cluster=c("group","time")))

y4.fe.int <- plm(p6.y4.cfw.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+t.unemp.rate+year.lin+year.lin*pctexfel,
                  data = fe.ov, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
...
#Estimates with Diability Measures (SSDI & ASEC Disability Rate)
```{r, warning=F}
...
y2.fe.d <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+ssdi.rate,
                  data = fe.ov, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
...
y3.fe.d <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+p6.disab.rate,
                  data = fe.ov, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
y3.fe.robust.d <- coeftest(y3.fe.d, vcov=vcovHC(y3.fe.d,type="HC0",cluster=c("group","time")))

y4.fe.d <- plm(p6.y1.notemployed.rate~pctexfel+popshare.26.35+popshare.36.45+popshare.46.55+popshare.56.65+popshare.66.plus+
                   ssi.rate+p6.marriage.rate+effective.wage+TANF.mu+z_labor_unemployment_compensatio+
                  t_1.unemp.rate+t_2.unemp.rate+t_3.unemp.rate+ssdi.rate+p6.disab.rate,
                  data = fe.ov, weights = norm.weight, index = c("STATENAME","YEAR"), model="within",effect="twoway")
y4.fe.robust.d <- coeftest(y4.fe.d, vcov=vcovHC(y4.fe.d,type="HC0",cluster=c("group","time")))



d.fe.robust.se <- list(y1.fe.robust.d[,2], y2.fe.robust.d[,2], y3.fe.robust.d[,2], y4.fe.robust.d[,2])
d.fe.robust.p <- list(y1.fe.robust.d[,4], y2.fe.robust.d[,4], y3.fe.robust.d[,4], y4.fe.robust.d[,4])

```

```{r, results='asis', echo=F}
stargazer(y1.fe.d, y2.fe.d, y3.fe.d, y4.fe.d,
          type="latex", style="aer", title="Models Including SSDI and ASEC Disability Rate", covariate.labels= c(
                                                  "Ex-Felon Percentage", 
                                                  "Population Share 26-35",
                                                  "Pop. Share 36-45","Pop. Share 46-55",
                                                  "Pop. Share 56-65","Pop. Share 66+", 
                                                  ...
                                                  "Ovr. Unemp. Rate t-1",
                                                  "Ovr. Unemp. Rate t-2","Ovr. Unemp. Rate t-3",
                                                  "Ovr. Unemp. Rate t", "SSDI","ASEC Disab."),
          header=F, p.auto=F,
          notes=c("Clustered Standard Errors by State and Year.", "Weighted by State-Year total pop."), 
...
map <- ggplot(usa.t) +
  geom_sf(aes(geometry = geometry, fill=density, frame = YEAR)) + #frame = specifies animation
    coord_sf(crs=2163)+
  scale_fill_distiller(palette = "Spectral",
                       breaks = c(seq(0,13,2)),
                       limits = c(0,13),
...
gganimate(map, interval=1.5, ani.width = 750, ani.height = 450,
